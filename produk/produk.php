...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['id_produk'])) {
    $id_produk = filter_input(INPUT_GET, 'id_produk', FILTER_SANITIZE_STRING);
    
    if ($id_produk) {
        $stmt = mysqli_prepare($conn, "SELECT gambar FROM product WHERE id = ?");
        mysqli_stmt_bind_param($stmt, "s", $id_produk);
        mysqli_stmt_execute($stmt);
        $result = mysqli_stmt_get_result($stmt);

        if ($row = mysqli_fetch_assoc($result)) {
            echo json_encode(['gambar' => $row['gambar']]);
        } else {
...
<head>
    ...
    <title>Product - Cemillicious</title>
        ...
        <div class="text-center mb-4">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="productDropdown">
                    ...
                    <li><a class="dropdown-item" href="dropdown_menu/produk_desserts.php" onclick="updateDropdown('Desserts')">Desserts</a></li>
                    <li><a class="dropdown-item" href="dropdown_menu/produk_drinks.php" onclick="updateDropdown('Drinks')">Drinks</a></li>
                    <li><a class="dropdown-item" href="dropdown_menu/produk_heavy_meals.php" onclick="updateDropdown('Heavy Meals')">Heavy Meals</a></li>
                    <li><a class="dropdown-item" href="dropdown_menu/produk_light_bites.php" onclick="updateDropdown('Light Bites')">Light Bites</a></li>
                </ul>
            </div>
            <p></p>
            ...
            <div class="row">
                ...
                if ($result->num_rows > 0) { 
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        $path_gambar = "../produk/gambar_produk/" . $nama_file_gambar;
